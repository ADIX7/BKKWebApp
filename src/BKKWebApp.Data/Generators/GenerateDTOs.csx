...
{
    if (typeof(IReadOnlyList<>).IsAssignableFrom(type) && type.IsGenericType)
    {
        return "IReadOnlyList<" + GetTypeText(type.GenericTypeArguments[0]) + ">";
    }
...
foreach (Type type in modelTypes)
{
    ...
    Output.WriteLine($@"//THIS FILE IS AUTOGENERATED
using System;
